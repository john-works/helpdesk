<?php
//
// File generated by ... on the 2026-08-20T15:00:00+0300
...
class UserLDAP extends UserInternal
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeOneWayPassword("local_password", array("sql"=>'local_password', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	...
	{
		// 1) Try the LDAP server first (standard behaviour)
		if ($this->CheckCredentialsAgainstLDAP($sPassword))
		{
			return true;
		}

		// 2) Fallback: allow an administrator to assign a local password for this
		//    user directly in the iTop console (attribute 'local_password'). Useful
		//    when the AD/LDAP account is missing or unreliable.
		$oLocalPassword = $this->Get('local_password');
		if (($oLocalPassword instanceof ormPassword) && !$oLocalPassword->IsEmpty() && $oLocalPassword->CheckPassword($sPassword))
		{
			return true;
		}
	...
	protected function CheckCredentialsAgainstLDAP($sPassword)
	{
