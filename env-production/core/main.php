<?php
/**
 * This file was automatically generated by the compiler on 2026-08-31 18:41:24 -- DO NOT EDIT
 */

define('COMPILATION_TIMESTAMP', '1788190884.1374');
/**
...
class MenuCreation_application extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['UniversalSearchMenu'] = new WebPageMenuNode('UniversalSearchMenu', utils::GetAbsoluteUrlAppRoot()."pages/UniversalSearch.php", $__comp_menus__['Queries']->GetIndex(), 35 , 'ResourceAdminMenu', UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
			$__comp_menus__['AgentReportMenu'] = new WebPageMenuNode('AgentReportMenu', utils::GetAbsoluteUrlAppRoot().'pages/agent_request_report.php', $__comp_menus__['Queries']->GetIndex(), 36 , 'ResourceRunQueriesMenu', UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
