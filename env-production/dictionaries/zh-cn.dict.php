...
- $current_contact->attribute$ 触发通知的用户的属性',
	...
	'Class:ActionNewsroom' => 'PPDA Help Desk通知',
...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => '一个同步数据源仅能填充一个 PPDA Help Desk 类型',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => '一个 (小) 图片的链接用以表示与 PPDA Help Desk 同步的应用.
该图标展示在 PPDA Help Desk 同步对象的 "锁定" 符号的提示框中',
	'Class:SynchroDataSource/Attribute:url_application' => '应用的超链接',
	'Class:SynchroDataSource/Attribute:url_application+' => '外部程序中对象的超链接, 对应PPDA Help Desk的同步对象. 
可能的占位符: $this->attribute$ 和 $replica->primary_key$.
该图标展示在PPDA Help Desk同步对象的 "锁定" 符号的提示框中',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => '一致性原则',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"使用属性": 对标记为复制的PPDA Help Desk对象匹配复制每一个同步的属性值.
"使用主键": 复制的字段主键应包含PPDA Help Desk对象的唯一标识',
...
审计域通常对应负责检查和修复错误的人',
	...
	'Class:UserInternal+' => 'PPDA Help Desk内部定义的用户',
	...
	'Menu:WelcomeMenu' => '欢迎',
	'Menu:WelcomeMenu+' => '欢迎使用PPDA Help Desk',
	'Menu:WelcomeMenuPage' => '欢迎',
	'Menu:WelcomeMenuPage+' => '欢迎使用PPDA Help Desk',
	'Menu:AdminTools' => '管理',
	...
	'BooleanLabel:yes' => '是',
	'BooleanLabel:no' => '否',
	'UI:Login:Title' => 'PPDA Help Desk登录',
	'UI:WelcomeMenu:Title' => '欢迎使用PPDA Help Desk',
	...
	'UI:SelectOne' => '-- 请选择 --',
	'UI:Login:Welcome' => '欢迎使用PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk将会给您发送一封密码重置邮件.',
	...
	'UI:ResetPwd-EmailSubject' => '重置PPDA Help Desk密码',
	'UI:ResetPwd-EmailBody' => '<body><p>您已请求重置PPDA Help Desk密码.</p><p>请点击这个链接 (一次性) <a href="%1$s">来输入新的密码</a></p>.',
	...
	'UI:Login:About' => 'PPDA Help Desk由 Combodo 创建',
	...
	'UI:LogOffMenu' => '注销',
	'UI:LogOff:ThankYou' => '感谢使用PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk是只读的',
	'UI:AccessRO-Users' => 'PPDA Help Desk对于终端用户是只读的',
	'UI:ApplicationEnvironment' => '应用环境: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => '新密码输入不一致!',
	'UI:Button:Login' => '登录PPDA Help Desk',
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Desk访问被限制. 请联系管理员.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - 批量导入',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - 全局搜索',
	...
	'UI:Audit:Title' => 'PPDA Help Desk - CMDB审计',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - OQL查询评估',
	...
	'UI:Query:UrlV1' => '没有定义字段列表. 没有这个信息页面<em>export-V2.php</em>无法调用. 因此, 建议的以下 URL 指向传统页面: <em>export.php</em>. 该传统版本导出具有以下限制: 导出的字段列表很大程度依赖于导出格式和PPDA Help Desk数据模型. <br/>如果您需要确保导出的列保持长期稳定, 则必须为属性 "Fields" 指定值并使用页面<em>export-V2.php</em>.',
	'UI:Schema:Title' => 'PPDA Help Desk对象模型',
	...
	'UI:WelcomeToITop' => '欢迎使用PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s 详细内容',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - 错误',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - 搜索结果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s 修改',
	'UI:ModificationTitle_Class_Object' => '修改 %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - 克隆 %1$s - %2$s 修改',
	'UI:CloneTitle_Class_Object' => '克隆 %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - 新建 %1$s',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - 批量删除',
	'UI:BulkDeleteTitle' => '选择您要删除的对象:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk 对象已创建.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - 致命错误',
	'UI:SystemIntrusion' => '访问被禁止. 您正尝试未被许可的操作.',
	'UI:FatalErrorMessage' => '致命错误, PPDA Help Desk无法继续.',
	'UI:Error_Details' => '错误: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk用户管理 - 角色映射',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>在PPDA Help Desk中, 通知可以被自定义. 它们是基于两个对象集: <i>触发器和操作</i>.</p>
<p><i><b>触发器</b></i>定义了什么时候发送通知. PPDA Help Desk内核自带一些触发器, 另一些触发器可由扩展提供:
<ol>
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk 用户门户',
...
<tr><td>s</td><td>秒 (2位数, 比如 00..59)</td></tr>
	...
	'UI:AboutBox' => '关于PPDA Help Desk...',
	'UI:About:Title' => '关于PPDA Help Desk',
	...
	'portal:backoffice' => 'PPDA Help Desk后台用户界面',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => '欢迎使用 PPDA Help Desk 3.2',
...
- 研发团队',
	...
	'Class:UserExternal+' => '用户在PPDA Help Desk外部验证身份',
	...
	'Class:UserLocal' => 'PPDA Help Desk 用户',
	'Class:UserLocal+' => '用户由PPDA Help Desk验证身份',
...
可能是因为您发送的是空文件,
或者咨询 PPDA Help Desk 管理员,检查 PPDA Help Desk 服务器硬盘是否满了.',
	...
	'bkp-mysqldump-notfound' => 'mysqldump找不到: %1$s - 请确认它安装在正确的路径, 或者调整PPDA Help Desk配置文件的参数mysql_bindir.',
	'bkp-mysqldump-issue' => 'mysqldump无法运行 (retcode=%1$d): 请确认它安装在正确的路径, 或者调整PPDA Help Desk配置文件的参数mysql_bindir',
	...
	'config-not-allowed-in-demo' => '抱歉, PPDA Help Desk处于<b>演示模式</b>: 不能编辑配置文件.',
	'config-interactive-not-allowed' => 'PPDA Help Desk交互式配置编辑器已禁用. 请在配置文件中查看 <code>\'config_editor\' => \'disabled\'</code>.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => '此组织里所有的PPDA Help Desk用户',
	'Class:Location' => '地点',
	...
	'iTopUpdate:UI:Setup' => 'PPDA Help Desk安装',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'PPDA Help Desk的磁盘空间',
	...
	'iTopUpdate:UI:SetupLaunch' => '启动PPDA Help Desk安装',
	'iTopUpdate:UI:SetupLaunchConfirm' => '将启动PPDA Help Desk安装, 确定吗?',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'PPDA Help Desk实例备份...',
...
请注意：如果设置了此参数，则会忽略“消息”参数。',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => '在此消息之后包含一个按钮，以在PPDA Help Desk中删除此对象',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => '在此消息之后包含一个按钮，以在PPDA Help Desk中修改此对象',
...
请注意：如果设置了此参数，则会忽略“消息”和所有的“自动程序信息”参数。',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => '在此消息之后包含一个按钮，以在PPDA Help Desk中删除此对象',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => '在此消息之后包含一个按钮，以在PPDA Help Desk中修改此对象',
...
——在某些情况下$oResponse可以为空（例如发送请求失败）',
	...
	'Class:ActioniTopWebhook' => 'PPDA Help Deskwebhook调用',
	'Class:ActioniTopWebhook+' => '远程PPDA Help Desk应用的Webhook调用',
	'Class:ActioniTopWebhook/Attribute:headers+' => 'HTTP请求的头信息，每个必须1行（例如：“Content-type: application/x-www-form-urlencoded”）

请注意：
——当应用为PPDA Help Desk时“Content-type”必须设置为“application/x-www-form-urlencoded”，即使发送的是JSON
...
请注意：如果设置了此参数，则会忽略“JSON数据”参数。',
	...
	'Class:RemoteiTopConnection' => '远程PPDA Help Desk连接',
	'Class:RemoteiTopConnection/Attribute:auth_pwd' => '验证密码',
	'Class:RemoteiTopConnection/Attribute:auth_pwd+' => '此身份验证所使用的用户（远程PPDA Help Desk）密码',
	'Class:RemoteiTopConnection/Attribute:auth_user' => '验证用户',
	'Class:RemoteiTopConnection/Attribute:auth_user+' => '此身份验证所使用的用户（远程PPDA Help Desk）登录名',
