...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'PPDA Help Deskが同期されたアプリケーションを示すハイパーリンク（小さな）イメージ',
	'Class:SynchroDataSource/Attribute:url_application' => 'アプリケーションのハイパーリンク',
	'Class:SynchroDataSource/Attribute:url_application+' => 'PPDA Help Deskが同期化された外部アプリケーションのPPDA Help Deskオブジェクトへのハイパーリンク（該当する場合）。可能なプレースホルダ: $this->attribute$ and $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Menu:WelcomeMenu+' => 'ようこそ、PPDA Help Deskへ',
	'Menu:WelcomeMenuPage' => 'ようこそ',
	'Menu:WelcomeMenuPage+' => 'ようこそ、PPDA Help Deskへ',
	...
	'UI:WelcomeMenu:Title' => 'ようこそ、PPDA Help Deskへ',
	...
	'UI:Login:Welcome' => 'PPDA Help Deskへようこそ',
	...
	'UI:LogOffMenu' => 'ログオフ',
	'UI:LogOff:ThankYou' => 'PPDA Help Deskをご利用いただき、ありがとうございます。',
	...
	'UI:AccessRO-All' => 'PPDA Help Deskは参照専用です。',
	'UI:AccessRO-Users' => 'エンドユーザの方はPPDA Help Deskは参照専用です。',
	'UI:ApplicationEnvironment' => 'アプリケーション環境: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => '2度入力された新しいパスワードが一致しません!',
	'UI:Button:Login' => 'PPDA Help Deskへ入る',
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Deskへのアクセスは制限されています。PPDA Help Desk管理者に問い合わせしてください。',
	'UI:Login:Error:AccessAdmin' => '管理者権限をもつユーザにアクセスが制限されています。PPDA Help Desk管理者に問い合わせしてください。',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - バルクインポート',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - ユニバーサル検索',
	...
	'UI:Audit:Title' => 'PPDA Help Desk - CMDB 監査',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - OQLクエリ評価',
	...
	'UI:Schema:Title' => 'PPDA Help Desk オブジェクトスキーマ',
	...
	'UI:WelcomeToITop' => 'PPDA Help Deskへようこそ',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$sの詳細',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - エラー',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - 検索結果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s 修正',
	'UI:ModificationTitle_Class_Object' => '%1$sの修正： <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - クローン%1$s - %2$s 修正',
	'UI:CloneTitle_Class_Object' => '%1$sのクローン：<span class=\\"hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - 新規%1$sを作成',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - バルク削除',
	'UI:BulkDeleteTitle' => '削除するオブジェクトを選択してください。',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Deskオブジェクトが作成されました。',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - 致命的なエラー',
	...
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk ユーザ管理 - プロフィールプロジェクション',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>PPDA Help Deskでは、通知はすべてカスタマイズが可能です。通知は<i>トリガーとアクション</i>という二つのオブジェクトがベースになっています。
...
トリガーに関連づけられると、各々のアクションは順番が与えられ、どの順序でアクションが実行されるかが指定されます。</p>',
	...
	'Portal:Title' => 'PPDA Help Deskユーザポータル',
...
- The R&amp;D Team',
	...
	'Class:UserLocal' => 'PPDA Help Deskユーザー',
	'Class:UserLocal+' => 'PPDA Help Deskローカル認証ユーザー',
