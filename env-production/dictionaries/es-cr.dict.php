...
Operadores:<br/>
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Una fuente de datos sincronizada solo puede completar una única clase PPDA Help Desk',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'URL a pequeña imagen representando la aplicación con la que PPDA Help Desk se sincronizará',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Utilice los atributos": PPDA Help Desk El objeto coincide con los valores de réplica para cada atributo Synchro marcado para reconciliación.
"Usar clave_primaria": se espera que la columna clave_primaria de la réplica contenga el identificador de PPDA Help Desk objeto',
...
El dominio suele corresponder a quién se encarga de comprobar y corregir errores.',
	...
	'Class:UserInternal+' => 'Usuario definido en PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Bienvenido a PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Bienvenido',
	'Menu:WelcomeMenuPage+' => 'Bienvenido a PPDA Help Desk',
	...
	'UI:WelcomeMenu:Title' => 'Bienvenido a PPDA Help Desk',
	...
	'UI:Login:Welcome' => 'Bienvenido a PPDA Help Desk',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk puede enviarle un correo en el cual encontrará las instrucciones a seguir para restablecer su contraseña.',
	...
	'UI:ResetPwd-EmailSubject' => 'Restablecer contraseña de PPDA Help Desk',
	'UI:ResetPwd-EmailBody' => '<body><p>Ha solicitado restablecer su contraseña en PPDA Help Desk.</p><p>Por favor de click en la siguiente liga: <a href="%1$s">proporcione una nueva contraseña</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Gracias por usar PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk está en modo de sólo lectura',
	'UI:AccessRO-Users' => 'PPDA Help Desk está en modo de sólo lectura para usuarios',
	...
	'UI:Login:Error:AccessRestricted' => 'El acceso a PPDA Help Desk está restringido. Por favor contacte al Administrador de PPDA Help Desk.',
	'UI:Login:Error:AccessAdmin' => 'Acceso restringido a usuarios con privilegio de administrador. Por favor contacte al Administrador de PPDA Help Desk.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - Importación por Lotes',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Busqueda Universal',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Evaluación de consultas OQL',
	...
	'UI:WelcomeToITop' => 'Bienvenido a PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - Detalles %2$s',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Resultados de la Búsqueda',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s modificación',
	'UI:ModificationTitle_Class_Object' => 'Modificación de %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Duplicar %1$s - %2$s modificación',
	'UI:CloneTitle_Class_Object' => 'Duplicado de %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Creación de %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Eliminar por lote',
	'UI:BulkDeleteTitle' => 'Seleccione los objetos que desea eliminar:',
	'UI:PageTitle:ObjectCreated' => 'Objeto de PPDA Help Desk creado.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Error Fatal',
	'UI:SystemIntrusion' => 'Acceso denegado. Esta tratando de ejecutar una operación no permitida para usted.',
	'UI:FatalErrorMessage' => 'Error fatal, PPDA Help Desk no puede continuar.',
	'UI:Error_Details' => 'Error: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'Administración de usuarios PPDA Help Desk - proyecciones de Perfil',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>En PPDA Help Desk las notificaciones son completamente personalizables. Están basadas en dos conjuntos de objetos: <i>Disparadores y Acciones</i>.</p>
...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
	...
	'Portal:NoRequestMgmt' => 'Estimado(a) %1$s, ha sido redirigido a esta página porque su cuenta está configurada con el Perfil \'Portal user\'.Desafortunadamente, PPDA Help Desk no fue instalado con el módulo \'Request Management\'.Por favor contacte a su Administrador.',
	...
	'Portal:ErrorNoContactForThisUser' => 'Error: el Usuario no está asociado con un Contacto/Persona. Por favor contacte al Administrador de PPDA Help Desk',
	...
	'UI:AutoApplyConfirmationMessage' => 'Algunos cambios no han sido aplicados todavía. ¿Quiere que PPDA Help Desk los tome en cuenta?',
...
<tr><td>s</td><td>segundos (2 digitos, ejem. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Acerca de PPDA Help Desk...',
	'UI:About:Title' => 'Acerca de PPDA Help Desk',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Sus noticias de PPDA Help Desk',
...
- El Equipo de I&amp;D',
	...
	'Class:UserExternal+' => 'Usuario autenticado fuera de PPDA Help Desk',
	...
	'Class:UserLocal' => 'Usuario de PPDA Help Desk',
	'Class:UserLocal+' => 'Usuario Autenticado vía PPDA Help Desk',
...
o pregunte al administador de iTop si el servidor que ha quedado sin espacio en disco.',
	...
	'config-not-allowed-in-demo' => 'Lo sentimos, PPDA Help Desk está en <b>modo de demostración</b>: el archivo de configuración no se puede editar.',
	'config-interactive-not-allowed' => 'PPDA Help Desk edición interactiva de la configuración como deshabilitada. Consulte <code>\'config_editor\' => \'disabled\'</code> en el archivo de configuración.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'iTopUpdate:UI:Setup' => 'Configuración PPDA Help Desk',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Espacio en disco de PPDA Help Desk',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Inicie configuración PPDA Help Desk',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Esto iniciará configuración PPDA Help Desk, ¿Está seguro?',
	...
	'Menu:iTopHub:Register+' => 'Ir a iTop Hub para actualizar su instancia de PPDA Help Desk',
	'Menu:iTopHub:Register:Description' => '<p>Obtenga acceso a la plataforma comunitaria iTop Hub!<br>Encuentre todo el contenido e información que necesite, adminitre sus instancias a través de herramientas personalizadas e instale más extensiones.<br><br>Mediante la conexión al Hub desde esta página, usted compartirá información acerca de esta instancia de PPDA Help Desk en el Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Extensiones instaladas',
	'Menu:iTopHub:MyExtensions+' => 'Vea la lista de extensiones instalada en esta instancia de PPDA Help Desk',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Vea en "iTop Hub’s store", su único lugar para encontrar extensiones de PPDA Help Desk.<br>Encuentre aquellas que le ayuden a personalizar y adaptar PPDA Help Desk a sus procesos.<br><br>Mediante la conexión al Hub desde esta página, usted compartirá información acerca de esta instancia de PPDA Help Desk en el Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Error detectado durante la instalación!<br>La configuración de PPDA Help Desk NO fue modificada.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Las siguientes extensiones fueron instaladas copiandolas manualmente en el directorio %1$s de PPDA Help Desk:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Navegue en iTop Hub para encontrar aquellas que le ayuden a personalizar y adaptar PPDA Help Desk a sus procesos !',
	'iTopHub:ExtensionNotInstalled' => 'No instalada',
	'iTopHub:GetMoreExtensions' => 'Obtener extensiones de iTop Hub...',
	'iTopHub:LandingWelcome' => '¡Felicidades! Las siguientes extensiones fueron descargadas de iTop Hub e instaladas en su PPDA Help Desk.',
	'iTopHub:GoBackToITopBtn' => 'Regresar a PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Realice un respaldo de la base de datos y configuración de PPDA Help Desk antes de actualizar.',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Respaldo de Instancia de PPDA Help Desk...',
...
Borre el campo para recalcular el valor predeterminado',
	...
	'Class:PersonalToken+' => 'Token Personal para acceder a PPDA Help Desk servicios web, importación, exportación, REST y sincronización de datos',
	...
	'Class:UserToken+' => 'Usuario para aplicaciones remotas que acceden a PPDA Help Desk servicios web',
...
IMPORTANTE: Si se habilita, el \'mensaje\' será ignorados.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Incluya un botón debajo del mensaje para eliminar el objeto en PPDA Help Desk',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en PPDA Help Desk',
...
IMPORTANTE: Si se habilita, el \'mensaje\' y toda la \'información bot\' serán ignorados.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Incluir un botón debajo del mensaje para eliminar el objeto en PPDA Help Desk',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Incluir un botón debajo del mensaje para editar el objeto en PPDA Help Desk',
...
IMPORTANTE: Si se habilita, el atributo \'JSON data\' será ignorado.',
	...
	'Class:RemoteApplicationType/Attribute:action_explanation+' => 'Explicación sobre cómo configurar una acción webhook en PPDA Help Desk (activada por un disparador) para esa aplicación. Por ejemplo, cómo construir una carga o qué esperar en la respuesta.',
