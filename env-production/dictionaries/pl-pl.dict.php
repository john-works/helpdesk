...
- W przeciwnym razie użyte zostanie kompaktowe logo aplikacji',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Synchroniczne źródło danych może zapełnić tylko jedną klasę PPDA Help Desk',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperłącze (mały) obraz przedstawiający aplikację, z którą synchronizowany jest PPDA Help Desk',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hiperłącze do aplikacji',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperłącze do obiektu PPDA Help Desk w zewnętrznej aplikacji, z którą PPDA Help Desk jest zsynchronizowany (jeśli dotyczy). Możliwe symbole zastępcze: $this->attribute$ i $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Polityka uzgadniania',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Użyj atrybutów": PPDA Help Desk obiekt odpowiada wartościom replik dla każdego atrybutu Synchro oznaczonego jako Uzgadnianie.
"Użyj klucza podstawowego": oczekuje się, że kolumna klucz_podstawowy repliki będzie zawierać identyfikator obiektu PPDA Help Desk',
...
Domena zazwyczaj odpowiada temu, kto jest odpowiedzialny za sprawdzanie i naprawianie błędów',
	...
	'Class:UserInternal+' => 'Użytkownik zdefiniowany w ramach PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Witaj w PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Witaj',
	'Menu:WelcomeMenuPage+' => 'Witaj w PPDA Help Desk',
	...
	'UI:WelcomeMenu:Title' => 'Witaj w PPDA Help Desk',
	...
	'UI:Error:UploadedFileTooBig' => 'Przesłany plik jest za duży. (Dopuszczalny rozmiar %1$s). Aby zmienić ten limit, skontaktuj się z administratorem PPDA Help Desk. (Sprawdź konfigurację PHP pod kątem upload_max_filesize i post_max_size na serwerze).',
	...
	'UI:Login:Welcome' => 'Witamy w PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk może wysłać Ci wiadomość e-mail, w której znajdziesz instrukcje dotyczące resetowania hasła.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset hasła PPDA Help Desk',
	'UI:ResetPwd-EmailBody' => '<body><p>Poprosiłeś o zresetowanie hasła PPDA Help Desk.</p><p>Proszę skorzystać z tego linku (jednorazowe użycie), <a href="%1$s">wpisz nowe hasło</a></p>.',
	...
	'UI:Login:About' => 'PPDA Help Desk Obsługiwane przez Combodo',
	...
	'UI:LogOff:ThankYou' => 'Dziękujemy za użycie PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk jest tylko do odczytu',
	'UI:AccessRO-Users' => 'PPDA Help Desk jest tylko do odczytu dla użytkowników końcowych',
	...
	'UI:Button:Login' => 'Wejdź do PPDA Help Desk',
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Desk dostęp jest ograniczony. Prosimy o kontakt z administratorem PPDA Help Desk.',
	'UI:Login:Error:AccessAdmin' => 'Dostęp ograniczony do osób z uprawnieniami administratora. Prosimy o kontakt z administratorem PPDA Help Desk.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - Import zbiorczy',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Wyszukiwanie uniwersalne',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Wykonywanie zapytań OQL',
	...
	'UI:WelcomeToITop' => 'Witaj w PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s szczegóły',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Błąd',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Wyniki wyszukiwania',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s zmiana',
	'UI:ModificationTitle_Class_Object' => 'Zmiana %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Klonuj %1$s - %2$s zmianę',
	'UI:CloneTitle_Class_Object' => 'Klonuje %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Tworzenie %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Usuń zbiorczo',
	'UI:BulkDeleteTitle' => 'Wybierz obiekty, które chcesz usunąć:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Utworzono obiekt.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Błąd krytyczny',
	'UI:SystemIntrusion' => 'Brak dostępu. Zażądałeś operacji, która nie jest dla Ciebie dozwolona.',
	'UI:FatalErrorMessage' => 'Błąd krytyczny, PPDA Help Desk nie może kontynuować.',
	'UI:Error_Details' => 'Błąd: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk zarządzanie użytkownikami - projekcje profili',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>W PPDA Help Desk powiadomienia są w pełni konfigurowalne. Opierają się na dwóch zestawach obiektów: <i> wyzwalaczach i działaniach </i>.</p>
<p><i><b>Wyzwalacze</b></i> określają, kiedy powiadomienie zostanie wykonane. W ramach programu istnieją różne wyzwalacze PPDA Help Desk, ale inne mogą zostać wprowadzone przez rozszerzenia:
<ol>
...
W przypadku powiązania z wyzwalaczem, każde działanie otrzymuje numer "porządkowy", określający, w jakiej kolejności mają być wykonywane.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk portal użytkownika',
	'Portal:NoRequestMgmt' => 'Drogi %1$s, zostałeś przekierowany na tę stronę, ponieważ Twoje konto jest skonfigurowane z profilem \'Portal użytkownika\'.Niestety, PPDA Help Desk nie został zainstalowany z funkcją \'Zarządzanie zgłoszeniami\'.Skontaktuj się z administratorem.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Niektóre zmiany nie zostały jeszcze zastosowane. Czy chcesz aby PPDA Help Desk wziął je pod uwagę?',
...
<tr><td>s</td><td>sekundy (2 cyfry, np. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'O PPDA Help Desk...',
	'UI:About:Title' => 'O PPDA Help Desk',
	...
	'portal:backoffice' => 'PPDA Help Desk Interfejs użytkownika biurowego',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Twoje wiadomości PPDA Help Desk',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Witaj w PPDA Help Desk 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulacje, trafiłeś do PPDA Help Desk Fullmoon!</div>
<br>
<div>Z radością ogłaszamy tę nową wersję. </div>
<div>Oprócz wprowadzenia nowych funkcji, takich jak Newsroom, PPDA Help Desk wersja 3.2 zawiera krytyczne poprawki bezpieczeństwa, zwiększoną dostępność i inne znaczące ulepszenia mające na celu zapewnienie stabilności i bezpieczeństwa.</div>
<br>
<div>Odkryj wszystkie ekscytujące nowe funkcje PPDA Help Desk i bądź na bieżąco z ważnymi powiadomieniami dzięki naszemu nowemu wyskakującemu okienku powitalnemu!</div>
<div>Mamy nadzieję, że spodoba ci się ta wersja tak samo, jak nam podobało się jej wyobrażanie i tworzenie.</div>
<br>
<div>Dostosuj swoją aplikację PPDA Help Desk w preferencjach dotyczących spersonalizowanych doświadczeń.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Przywitaj się z newsroomem',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Pożegnaj zaśmiecone skrzynki odbiorcze i przywitaj się ze spersonalizowanymi alertami <a href="%1$s" target="_blank">PPDA Help Desk\'s Newsroom</a>!</div>
...
<br>
<div>Wypróbuj już dziś i usprawnij swoje doświadczenie komunikacji w PPDA Help Desk!</div>',
...
<div>Uzyskaj dostęp do swojego centrum powiadomień poprzez newsroom lub poprzez swoje preferencje i unikaj przeciążenia informacjami we wszystkich kanałach komunikacji!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Dostępność PPDA Help Desk',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>Aby zapewnić dostępnośćPPDA Help Desk, nasz zespół pracował nad nowymi motywami zaplecza. Zgodny z WCAG, interfejs użytkownika skupia się na ułatwieniu użytkownikom z wadami wzroku korzystania z rozwiązania:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>PPDA Help Desk Newsroom oferuje nowy sposób <b>automatyzacji</b> alertów na podstawie powtarzających się zdarzeń, dzięki czemu możesz łatwo skonfigurować odpowiednie dla siebie reguły. </div>
...
- Zespół R&amp;D',
	...
	'Class:UserExternal+' => 'Użytkownik uwierzytelniony poza PPDA Help Desk',
	...
	'Class:UserLocal' => 'Użytkownik PPDA Help Desk',
	'Class:UserLocal+' => 'Użytkownik uwierzytelniony przez PPDA Help Desk',
...
lub zapytaj administratora PPDA Help Desk, czy dysk serwera PPDA Help Desk jest pełny.',
	...
	'config-not-allowed-in-demo' => 'Sorry, PPDA Help Desk jest w <b>trybie demonstracyjnym</b>: nie można edytować pliku konfiguracyjnego.',
	'config-interactive-not-allowed' => 'PPDA Help Desk interaktywna edycja konfiguracji została wyłączona. Zobacz <code>\'config_editor\' => \'disabled\'</code> w pliku konfiguracyjnym.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'iTopUpdate:UI:Setup' => 'Konfiguracja PPDA Help Desk',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Przestrzeń dyskowa  PPDA Help Desk',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Uruchom konfigurację PPDA Help Desk',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Zostanie uruchomiona PPDA Help Desk konfiguracja, jesteś pewien?',
	...
	'Menu:iTopHub:Register+' => 'Przejdź do iTop Hub, aby zaktualizować swoją instancję PPDA Help Desk',
	'Menu:iTopHub:Register:Description' => '<p>Uzyskaj dostęp do swojej platformy społecznościowej iTop Hub!</br>Znajdź wszystkie potrzebne treści i informacje, zarządzaj swoimi instancjami za pomocą spersonalizowanych narzędzi i zainstaluj więcej rozszerzeń.</br><br/>Łącząc się z Centrum z tej strony, będziesz przesyłać informacje o tej instancji PPDA Help Desk do Centrum.</p>',
	'Menu:iTopHub:MyExtensions' => 'Wdrożone rozszerzenia',
	'Menu:iTopHub:MyExtensions+' => 'Zobacz listę rozszerzeń wdrożonych w tej instancji PPDA Help Desk',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Zajrzyj do sklepu iTop Hub, jedynego miejsca, w którym można znaleźć wspaniałe rozszerzenia PPDA Help Desk!</br>Znajdź te, które pomogą Ci dostosować i dostosować PPDA Help Desk do Twoich procesów.</br><br/>Łącząc się z Centrum z tej strony, będziesz przesyłać informacje o tej instancji PPDA Help Desk do Centrum.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Wykryto błąd podczas wdrażania!<br/>Konfiguracja PPDA Help Desk NIE została zmodyfikowana.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Następujące rozszerzenia zostały wdrożone przez ręczne skopiowanie ich do katalogu %1$s programu PPDA Help Desk:',
	...
	'iTopHub:NoExtensionInThisCategory' => 'W tej kategorii nie ma rozszerzenia.<br/><br/>Przeglądaj iTop Hub, aby znaleźć rozszerzenia, które pomogą Ci dostosować i dostosować PPDA Help Desk do Twoich procesów.',
	...
	'iTopHub:LandingWelcome' => 'Gratulacje! Następujące rozszerzenia zostały pobrane z iTop Hub i wdrożone w PPDA Help Desk.',
	'iTopHub:GoBackToITopBtn' => 'Wróć do PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Przed aktualizacją wykonaj kopię zapasową bazy danych i konfiguracji PPDA Help Desk',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Kopia zapasowa instancji PPDA Help Desk...',
