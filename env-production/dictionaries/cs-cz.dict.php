...
- V opačném případě se použije kompaktní logo aplikace',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Zdroj dat pro synchronizaci může naplnit pouze jednu třídu PPDA Help Desk',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hypertextový odkaz na ikonu reprezentující aplikaci, se kterou je PPDA Help Desk synchronizovnán',
	'Class:SynchroDataSource/Attribute:url_application' => 'Aplikace',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hypertextový odkaz na PPDA Help Desk objekt v externí aplikaci, se kterou je PPDA Help Desk synchronizován (pokud je to relevantní). Možné zástupné symboly: $this->attribute$ a $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Způsob párování',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Použijte atribut": PPDA Help Desk objekt odpovídá hodnotám replik pro jednotivé atributy synchronizace označené pro odsouhlasení.
"Použít primary_key": sloupec primary_key repliky by měl obsahovat identifikátor objektu PPDA Help Desk',
...
Domény nejčastěji odpovídají skupinám řešitelů, které následně opravují chyby nalezené auditem',
	...
	'Class:UserInternal+' => 'Uživatel definovaný v PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Vítejte v PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Vítejte',
	'Menu:WelcomeMenuPage+' => 'Vítejte v PPDA Help Desk',
	...
	'UI:WelcomeMenu:Title' => 'Vítejte v PPDA Help Desk',
	...
	'UI:Login:Welcome' => 'Vítejte v PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk vám může zaslat instrukce pro obnovení vašeho hesla.',
	...
	'UI:ResetPwd-EmailSubject' => 'Obnovení hesla pro PPDA Help Desk',
	'UI:ResetPwd-EmailBody' => '<body><p>Vyžádali jste obovení hesla pro PPDA Help Desk.</p><p>Pokračujte kliknutím na následující <a href="%1$s">jednorázový odkaz</a> a zadejte nové heslo.</p>',
	...
	'UI:LogOff:ThankYou' => 'Děkujeme za užívání PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk je pouze ke čtení',
	'UI:AccessRO-Users' => 'PPDA Help Desk je pouze ke čtení pro koncové uživatele',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - hromadný import',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Univerzální hledání',
	...
	'UI:CSVExport:LostChars+' => 'CSV soubor bude kódován v %1$s. PPDA Help Desk zjistil, že některé charaktery nejsou s tímto kódováním kompatibilní. Tyto znaky budou nahrazeny zástupným znakem, nebo budou vynechány. Kontaktujte administrátora pro změnu kódování (parametr \'csv_file_default_charset\').',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Vyhodnocení OQL dotazu',
	...
	'UI:Schema:Title' => 'PPDA Help Desk schéma objektů',
	...
	'UI:WelcomeToITop' => 'Vítejte v PPDA Help Desk',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Výsledky hledání',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - úprava - %1$s - %2$s',
	'UI:ModificationTitle_Class_Object' => 'Úprava %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Klonování %1$s - %2$s',
	'UI:CloneTitle_Class_Object' => 'Klonování %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Vytváření nového objektu (%1$s) ',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Hromadné odstranění',
	'UI:BulkDeleteTitle' => 'Vyberte objekty, které chcete odstranit:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Objekt vytvořen.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Závažná chyba',
	'UI:SystemIntrusion' => 'Přístup odepřen. Vyžadujete operaci, která vám není povolena.',
	'UI:FatalErrorMessage' => 'Závažná chyba, PPDA Help Desk nemůže pokračovat.',
	'UI:Error_Details' => 'Chyba: %1$s',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk správa uživatelů - projekce profilů',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Upozornění v PPDA Help Desk jsou plně nastavitelné. Jsou založena na dvou druzích objektů: <i>trigery (spouštěče) a akce</i>.</p>
<p><i><b>Trigery</b></i> definují, kdy bude oznámení provedeno. Součástí jádra PPDA Help Desk jsou různé trigery, ale další mohou být přidány rožšířením:
<ol>
...
<p>Aby mohly být akce spuštěny, musí být přiřazeny ke trigerům. Každá akce pak dostane své "pořadové" číslo, které určí v jakém pořadí se akce spustí.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk uživatelský portál',
	'Portal:NoRequestMgmt' => 'Byli jste přesměrováni na tuto stránku, protože k vašemu účtu je přidělen profil \'Portal user\'. PPDA Help Desk však nebyl nainstalován s funkcí \'Request Management\'.Kontaktujte prosím vašeho administrátora.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Některé změny nebyly dosud použity. Chcete aby je PPDA Help Desk zohlednil?',
	...
	'portal:backoffice' => 'PPDA Help Desk Back-Office',
	...
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Vaše PPDA Help Desk novinky',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Vítejte v PPDA Help Desk 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Gratulujeme, přistáli jste do PPDA Help Desk Fullmoon!</div>
<br>
<div>Jsme rádi, že vám můžeme představit tuto novou verzi. </div>
<div>Kromě nových funkcionalit, jako je např. Newsroom, PPDA Help Desk obsahuje verze 3.2 bezpečnostní opravy, lepší přístupnost a další významná vylepšení zaměřená na zajištění stability a bezpečnosti.</div>
<br>
<div>Objevte všechny PPDA Help Desk vzrušující nové funkce a zůstaňte informováni o důležitých oznámeních a aktualizacích prostřednictvím nového vyskakovacího okna na uvítanou!</div>
<div>Doufáme, že se vám tato verze bude líbit stejně, jako se nám líbila její tvorba.</div>
<br>
<div>Přizpůsobte si svoje předvolby PPDA Help Desk a získejte tak individuální zážitek.</div>',
...
- The R&amp;D Team',
	...
	'Class:UserExternal+' => 'Uživatel definovaný mimo PPDA Help Desk',
	...
	'Class:UserLocal' => 'interní uživatel PPDA Help Desk',
	'Class:UserLocal+' => 'Uživatel ověřen interně v PPDA Help Desk',
...
nebe se zeptejtePPDA Help Desk správce PPDA Help Desk zda není zaplněný disk.',
	...
	'config-edit-intro' => 'Při úpravách konfiguračního souboru buďte velice opatrní. Nesprávné nastavení může vést k nedostupnosti PPDA Help Desk',
	'config-apply' => 'Použít',
	...
	'config-not-allowed-in-demo' => 'Omlouvám se, PPDA Help Desk je v <b>předváděcí režimu</b>: Konfigurace nemůže být editována',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'PPDA Help Desk Uživatelé v rámci této organizace',
	...
	'Menu:iTopHub:MyExtensions+' => 'Seznam rozšíření nasazených v rámci instance PPDA Help Desk',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Tato rozšíření byla nasazena manuálně a to kopiií souborů do adresáře %1$s instance PPDA Help Desk:',
	...
	'iTopHub:LandingWelcome' => 'Gratuluji! Následující rozšíření jsou úspěšně stažena z iTop Hubu a nasazena v rámci instance PPDA Help Desk.',
