...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyperlink a (small) image representing the application with which PPDA Help Desk is synchronized.
This icon is shown in the tooltip of the “Lock” symbol on PPDA Help Desk synchronized object',
	'Class:SynchroDataSource/Attribute:url_application' => 'Application\'s hyperlink',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink to the object in the external application corresponding to a synchronized PPDA Help Desk object. 
Possible placeholders: $this->attribute$ and $replica->primary_key$.
The hyperlink is displayed in the tooltip appearing on the “Lock” symbol of any synchronized PPDA Help Desk object',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:User/Attribute:login+' => 'Account identification string, must be unique within PPDA Help Desk',
	'Class:User/Attribute:language' => 'Language',
	'Class:User/Attribute:language+' => 'Default PPDA Help Desk language for this user, to choose amoungst languages in which PPDA Help Desk was localized . ',
	...
	'Class:UserInternal+' => 'User defined within PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Welcome to PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Welcome',
	'Menu:WelcomeMenuPage+' => 'Welcome to PPDA Help Desk',
	...
	'BooleanLabel:no' => 'no',
	'UI:Login:Title' => 'PPDA Help Desk login',
	'UI:WelcomeMenu:Title' => 'Welcome to PPDA Help Desk',
	...
	'UI:Error:UploadedFileTooBig' => 'The uploaded file is too big. (Max allowed size is %1$s). To modify this limit, contact your PPDA Help Desk administrator. (Check the PHP configuration for upload_max_filesize and post_max_size on the server).',
	...
	'UI:Login:Welcome' => 'Welcome to PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk can send you an email in which you will find instructions to follow to reset your account.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset your PPDA Help Desk password',
	'UI:ResetPwd-EmailBody' => '<body><p>You have requested to reset your PPDA Help Desk password.</p><p>Please follow this link (single usage) to <a href="%1$s">enter a new password</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Thank you for using PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk is read-only',
	'UI:AccessRO-Users' => 'PPDA Help Desk is read-only for end-users',
	...
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Desk access to this page is restricted. Please, contact an PPDA Help Desk administrator.',
	'UI:Login:Error:AccessAdmin' => 'Access restricted to people having administrator privileges. Please, contact an PPDA Help Desk administrator.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - Bulk import',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Universal Search',
	...
	'UI:CSVExport:LostChars+' => 'The downloaded file will be encoded into %1$s. PPDA Help Desk has detected some characters that are not compatible with this format. Those characters will either be replaced by a substitute (e.g. accentuated chars losing the accent), or they will be discarded. You can copy/paste the data from your web browser. Alternatively, you can contact your administrator to change the encoding (See parameter \'csv_file_default_charset\').',
	'UI:Audit:Title' => 'PPDA Help Desk - CMDB Audit',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - OQL Query Evaluation',
	...
	'UI:Query:UrlV1' => 'The list of fields has been left unspecified. The page <em>export-V2.php</em> cannot be invoked without this information. Therefore, the URL suggested here below points to the legacy page: <em>export.php</em>. This legacy version of the export has the following limitation: the list of exported fields may vary depending on the output format and the data model of PPDA Help Desk. <br/>Should you want to guarantee that the list of exported columns will remain stable on the long run, then you must specify a value for the attribute "Fields" and use the page <em>export-V2.php</em>.',
	'UI:Schema:Title' => 'PPDA Help Desk objects schema',
	...
	'UI:WelcomeToITop' => 'Welcome to PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s details',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Error',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Search Results',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s modification',
	'UI:ModificationTitle_Class_Object' => 'Modification of %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Clone %1$s - %2$s modification',
	'UI:CloneTitle_Class_Object' => 'Clone of %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Creation of a new %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Bulk Delete',
	'UI:BulkDeleteTitle' => 'Select the objects you want to delete:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Object Created.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Fatal Error',
	'UI:SystemIntrusion' => 'Access denied. You have requested an operation that is not allowed for you.',
	'UI:FatalErrorMessage' => 'Fatal error, PPDA Help Desk cannot continue.',
	'UI:Error_Details' => 'Error: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk user management - profile projections',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In PPDA Help Desk the notifications are fully customizable. They are based on two sets of objects: <i>triggers and actions</i>.</p>
<p><i><b>Triggers</b></i> define when a notification will be executed. There are different triggers as part of PPDA Help Desk core, but others can be brought by extensions:
<ol>
...
When associated with a trigger, each action is given an "order" number, specifying in which order the actions are to be executed.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk user portal',
	'Portal:NoRequestMgmt' => 'Dear %1$s, you have been redirected to this page because your account is configured with the profile \'Portal user\'. Unfortunately, PPDA Help Desk has not been installed with the feature \'Request Management\'. Please contact your administrator.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Some changes have not been applied yet. Do you want PPDA Help Desk to take them into account?',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'About PPDA Help Desk...',
	'UI:About:Title' => 'About PPDA Help Desk',
	...
	'portal:backoffice' => 'PPDA Help Desk Back-Office User Interface',
	...
	'Menu:AuditCategories+' => 'Define rules to audit the quality of PPDA Help Desk data',
	...
	'Menu:UserManagementMenu+' => 'Who can connect to PPDA Help Desk and what can they do?',
	...
	'Menu:UserAccountsMenu+' => 'Handling PPDA Help Desk users and their access rights',
...
- The R&amp;D Team',
	...
	'Class:UserExternal+' => 'User authentified outside of PPDA Help Desk',
	'Class:UserLDAP' => 'LDAP user',
	'Class:UserLDAP+' => 'User authenticated by LDAP',
	'UserLDAP:server' => 'LDAP specifics',
	'Class:UserLocal' => 'PPDA Help Desk user',
	'Class:UserLocal+' => 'User authentified by PPDA Help Desk',
...
or ask your PPDA Help Desk administrator if the PPDA Help Desk server disk is full.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'PPDA Help Desk Users within this organization',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'PPDA Help Desk disk space',
	...
	'Menu:iTopHub:Register+' => 'Go to iTop Hub to update your PPDA Help Desk instance',
	'Menu:iTopHub:Register:Description' => '<p>Get access to your community platform iTop Hub!<br>Find all the content and information you need, manage your instances through personalized tools & install more extensions.<br><br>By connecting to the Hub from this page, you will push information about this PPDA Help Desk instance into the Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Deployed extensions',
	'Menu:iTopHub:MyExtensions+' => 'See the list of extensions deployed on this instance of PPDA Help Desk',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Look into iTop Hub’s store, your one stop place to find wonderful iTop extensions !<br>Find the ones that will help you customize and adapt PPDA Help Desk to your processes.<br><br>By connecting to the Hub from this page, you will push information about this PPDA Help Desk instance into the Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Error detected during deployment!<br>PPDA Help Desk configuration has NOT been modified.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'The following extensions have been deployed by copying them manually in the %1$s directory of PPDA Help Desk:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Browse iTop Hub to find the extensions that will help you customize and adapt PPDA Help Desk to your processes !',
	'iTopHub:ExtensionNotInstalled' => 'Not installed',
	'iTopHub:GetMoreExtensions' => 'Get extensions from iTop Hub...',
	'iTopHub:LandingWelcome' => 'Congratulations! The following extensions were downloaded from iTop Hub and deployed into your PPDA Help Desk.',
	'iTopHub:GoBackToITopBtn' => 'Go Back to PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Do a backup of the database and PPDA Help Desk configuration before updating',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'PPDA Help Desk Instance backup...',
...
Erase the field to recalculate default value',
	...
	'Menu:UserRequest:PPDAReport' => 'Report',
	'Menu:UserRequest:PPDAReport+' => '',
