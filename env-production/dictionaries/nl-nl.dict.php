...
Het domein komt meestal overeen met wie er verantwoordelijk is om de fouten te controleren en oplossen',
	...
	'Class:UserInternal+' => 'Gebruiker gedefinieerd in PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Welkom in PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Welkom',
	'Menu:WelcomeMenuPage+' => 'Welkom in PPDA Help Desk',
	...
	'BooleanLabel:yes' => 'Ja',
	'BooleanLabel:no' => 'Nee',
	'UI:Login:Title' => 'Aanmelden in PPDA Help Desk',
	'UI:WelcomeMenu:Title' => 'Welkom in PPDA Help Desk',
	...
	'UI:Error:UploadedFileTooBig' => 'Het geüploade bestand is te groot. De maximale grootte is %1$s. Contacteer jouw PPDA Help Desk-beheerder om deze limiet aan te passen. (Controleer de PHP-configuratie voor "upload_max_filesize" en "post_max_size" op de server).',
	...
	'UI:Login:Welcome' => 'Welkom in PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk kan je een e-mail sturen waarin de instructies voor het resetten van jouw account staan.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset jouw PPDA Help Desk-wachtwoord',
	'UI:ResetPwd-EmailBody' => '<body><p>Je hebt een reset van jouw PPDA Help Desk-wachtwoord aangevraagd.</p><p>Klik op deze link (eenmalig te gebruiken) om <a href="%1$s">een nieuw wachtwoord in te voeren</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Bedankt voor het gebruiken van PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk is alleen-lezen',
	'UI:AccessRO-Users' => 'PPDA Help Desk is alleen-lezen voor eindgebruikers',
	...
	'UI:Button:Login' => 'Ga naar PPDA Help Desk',
	'UI:Login:Error:AccessRestricted' => 'Geen toegang tot PPDA Help Desk.Neem contact op met een PPDA Help Desk-beheerder.',
	'UI:Login:Error:AccessAdmin' => 'Alleen toegankelijk voor mensen met beheerdersrechten. Neem contact op met een PPDA Help Desk-beheerder',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Universele zoekopdracht',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Evaluatie van OQL-query',
	...
	'UI:WelcomeToITop' => 'Welkom in PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s details',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Fout',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Zoekresultaten',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s aanpassing',
	'UI:ModificationTitle_Class_Object' => 'Aanpassen van %1$s: <span class="hilite">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Kloon %1$s - %2$s aanpassing',
	'UI:CloneTitle_Class_Object' => 'Klonen van %1$s: <span class="hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - %1$s aanmaken',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Meerdere objecten verwijderen',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Fatale Fout',
	'UI:SystemIntrusion' => 'Toegang geweigerd. Je hebt een actie aangevraagd waarvoor je niet gemachtigd bent.',
	'UI:FatalErrorMessage' => 'Fatale fout, PPDA Help Desk kan niet doorgaan.',
	'UI:Error_Details' => 'Fout: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk gebruikersbeheer - profiel-projecties',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In PPDA Help Desk zijn de meldingen volledig aan te passen. Ze zijn gebaseerd op twee sets van objecten: <i>triggers and actions</i>.</p>
<p><i><b>Triggers</b></i> bepalen wanneer er een melding is. Er zijn verschillende triggers als onderdeel van PPDA Help Desk core, maar andere kunnen door middel van uitbreidingen worden toegevoegd.
...
Bij die koppeling wordt aan elke actie een volgorde-nummer gegeven. Dit bepaalt in welke volgorde de acties moeten worden uitgevoerd.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk gebruikersportaal',
	'Portal:NoRequestMgmt' => 'Beste %1$s, je bent naar deze pagina doorverwezen omdat jouw account is geconfigureerd met het profiel "Portal user". Helaas is PPDA Help Desk niet geïnstalleerd met de optie "Request Management". Neem contact op met jouw beheerder.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Sommige veranderingen zijn nog niet doorgevoerd. Wil je dat PPDA Help Desk deze meeneemt?',
	...
	'UI:DashletUnknown:RenderText:Edit' => 'Kan deze dashlet niet weergeven (klasse "%1$s"). Controleer bij je PPDA Help Desk-beheerder of dit nog beschikbaar is.',
	...
	'UI:AboutBox' => 'Over PPDA Help Desk...',
	'UI:About:Title' => 'Over PPDA Help Desk',
...
- Het R&amp;D team',
	...
	'Class:UserLocal' => 'PPDA Help Desk-gebruiker',
	'Class:UserLocal+' => 'Gebruiker die aanmeldt met gegevens aangemaakt in het gebruikersbeheer van PPDA Help Desk',
	'Class:UserLocal/Attribute:password' => 'Wachtwoord',
	'Class:UserLocal/Attribute:password+' => 'Het wachtwoord waarmee de gebruiker zich aanmeldt bij PPDA Help Desk',
...
of vraag de iTop administrator om de opslagruimte van de iTop-server na te kijken',
	...
	'config-not-allowed-in-demo' => 'Sorry, PPDA Help Desk is in <b>demo mode</b>: Het configuratiebestand kan niet aangepast worden.',
	'config-interactive-not-allowed' => 'Interactieve aanpassing van de PPDA Help Desk configuratie is uitgeschackeld. Zie <code>\'config_editor\' => \'disabled\'</code> in het configuratiebestand.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'PPDA Help Desk-gebruikers in deze organisatie',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'PPDA Help Desk schijfgebruik',
	...
	'iTopUpdate:UI:CannotUpdateUseSetup' => '<b>Aangepaste bestanden gedetecteerd</b>, gedeeltelijke update kan niet uitgevoerd worden.</br>Volg de <a target="_blank" href="%2$s">procedure</a> om PPDA Help Desk manueel te updaten. Je moet de <a href="%1$s">setup</a> gebruiken om de applicatie te updaten.',
	'iTopUpdate:UI:CheckInProgress' => 'Even geduld terwijl de integriteitscontrole loopt',
	'iTopUpdate:UI:SetupLaunch' => 'Start de PPDA Help Desk setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Dit zal de PPDA Help Desk setup uitvoeren, ben je zeker?',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Er trad een fout op bij de installatie!<br>PPDA Help Desk-configuratie werd NIET aangepast.',
	...
	'iTopHub:GoBackToITopBtn' => 'Terug naar PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Neem vooraf een backup van de database en PPDA Help Desk-configuratie vooraleer de update uit te voeren',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup PPDA Help Desk-omgeving...',
...
BELANGRIJK: Indien geconfigureerd, zal \'bericht\' genegeerd worden.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in PPDA Help Desk',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in PPDA Help Desk',
...
BELANGRIJK: Indien geconfigureerd, zullen \'bericht\' en alle \'bot-informatie\' genegeerd worden.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Voeg een knop toe onder het bericht om het object te verwijderen in PPDA Help Desk',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Voeg een knop toe onder het bericht om het object aan te passen in PPDA Help Desk',
