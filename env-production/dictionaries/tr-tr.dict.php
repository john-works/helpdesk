...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyprinlink, PPDA Help Desk\'un senkronize edildiği uygulamayı temsil eden (küçük) bir görüntü',
	'Class:SynchroDataSource/Attribute:url_application' => 'Uygulama\'nın köprüsü',
	'Class:SynchroDataSource/Attribute:url_application+' => 'PPDA Help Desk\'un senkronize edildiği harici uygulamadaki PPDA Help Desk nesnesine köprü (varsa). Muhtemel yer tutucular: $this->attribute$ ve $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'PPDA Help Desk\'ta tanımlanan kullanıcı',
	...
	'Menu:WelcomeMenu+' => 'PPDA Help Desk\'a Hoşgeldiniz',
	'Menu:WelcomeMenuPage' => 'Hoşgeldiniz',
	'Menu:WelcomeMenuPage+' => 'PPDA Help Desk\'a Hoşgeldiniz',
	...
	'UI:WelcomeMenu:Title' => 'PPDA Help Desk\'a Hoşgeldiniz',
	...
	'UI:Login:Welcome' => 'PPDA Help Desk\'a Hoşgeldiniz!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk, hesabınızı sıfırlamak için izleyeceğiniz talimatları bulacağınız bir e-posta gönderebilir.',
	...
	'UI:ResetPwd-EmailSubject' => 'PPDA Help Deskşifrenizi sıfırlayın',
	'UI:ResetPwd-EmailBody' => '<body><p>PPDA Help Desk şifrenizin sıfırlanması talebinde bulundunuz.</p><p> Yeni şifre oluşturmak için lütfen aşağıdaki tek kullanımlık bağlantıyı <a href=\\"%1$s\\">takip ediniz.</a></p>',
	...
	'UI:LogOffMenu' => 'Çıkış',
	'UI:LogOff:ThankYou' => 'PPDA Help Desk Kullanıdığınız için teşekkürler',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk salt okunurdur',
	'UI:AccessRO-Users' => 'PPDA Help Desk sadece son kullanıcılar için okunurdur',
	'UI:ApplicationEnvironment' => 'Uygulama Ortamı: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => 'Yeni şifre eşlenmedi !',
	'UI:Button:Login' => 'PPDA Help Desk\'a Giriş',
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Desk erişim sınırlandırıldı. Sistem yöneticisi ile irtibata geçiniz',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - Toplu giriş',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Genel arama',
	...
	'UI:CSVExport:LostChars+' => 'İndirilen dosya %1$s\'ye kodlanır. PPDA Help Desk, bu formatla uyumlu olmayan bazı karakterleri tespit etti. Bu karakterler ya bir ikame ile değiştirilecektir (örneğin, vurgulanmış karakterleri aksanı kaybedilen) veya atılacaklardır. Verileri web tarayıcınızdan kopyalayabilir / yapıştırabilirsiniz. Alternatif olarak, kodlamayı değiştirmek için yöneticinize başvurabilirsiniz (bkz. Parametre \'csv_file_default_charset \').',
	'UI:Audit:Title' => 'PPDA Help Desk - CMDB Denetleme',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - OQL Sorgu değerlendirme',
	...
	'UI:WelcomeToITop' => 'PPDA Help Desk\'a Hoşgeldiniz',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s detayları',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Hata',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Arama Sonuçları',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s modifikasyon',
	'UI:ModificationTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> modifikasyonu',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s modifikasyonunu klonlayınız',
	'UI:CloneTitle_Class_Object' => '%1$s klonu: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Yeni %1$s yaratımı',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Toplu silme işlemi',
	'UI:BulkDeleteTitle' => 'Silmek istediğiniz nesneleri seçiniz:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Nesne yaratıldı.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Kritik Hata',
	...
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk Kullanıcı Yönetimi - profil koruması',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In PPDA Help Desk uyarı mekanizması ihtiyaca göre uyarlanabilir. Uyarılar iki tip nesne üzerine kurulmuştur: <i>tetikleme (triggers) ve işlemler (actions)</i>.</p>
...
Tetikleme gerçekleştiriğinde işlemler tanımlanan sıra numarası ile gerçekleştirilir.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk Kullanıcı Portalı',
	'Portal:NoRequestMgmt' => 'Sevgili %1$s, hesabınız profil \'Portal kullanıcısı \' ile yapılandırıldığından bu sayfaya yönlendirildiniz. Ne yazık ki, PPDA Help Desk, özellik \'istek yönetimi\' ile kurulmamıştır. Lütfen yöneticinize başvurun',
	...
	'UI:AutoApplyConfirmationMessage' => 'Bazı değişiklikler henüz uygulanmadı. PPDA Help Desk\'un değişiklikleri uygulamasını istiyor musunuz?',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'AboutPPDA Help Desk...',
	...
	'portal:backoffice' => 'PPDA Help DeskArka Ofis Kullanıcı Arayüzü',
...
- The R&amp;D Team',
	...
	'Class:UserExternal+' => 'PPDA Help Desk dışında yetki kontrolü yapılan kullanıcı',
	...
	'Class:UserLocal' => 'PPDA Help Desk kullanıcısı',
	'Class:UserLocal+' => 'Yetki kontorlünü PPDA Help Desk tarafından yapılan kullanıcı',
