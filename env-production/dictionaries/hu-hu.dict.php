...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperhivatkozás egy (kis) képre, amely azt az alkalmazást ábrázolja, amellyel a PPDA Help Desk szinkronizálva van.',
	'Class:SynchroDataSource/Attribute:url_application' => 'Alkalmazás URL',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperhivatkozás a PPDA Help Desk objektumra abban a külső alkalmazásban, amellyel a PPDA Help Desk szinkronizálva van (ha van ilyen). Lehetséges helyörzők: $this->attribute$ és $replica->primary_key$',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'PPDA Help Desk-n belül létrehozott felhasználó',
	...
	'BooleanLabel:no' => 'Nem',
	'UI:Login:Title' => 'PPDA Help Desk bejelentkezés',
	'UI:WelcomeMenu:Title' => 'Üdvözli az PPDA Help Desk',
	...
	'UI:Login:Welcome' => 'Üdvözli az PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk küldhet Önnek egy emailt, amelyben utasításokat talál a fiókja visszaállításához.',
	...
	'UI:ResetPwd-EmailSubject' => 'Állítsa vissza az PPDA Help Desk jelszavát',
	'UI:ResetPwd-EmailBody' => '<body><p>Ön vissza szeretné állítani az PPDA Help Desk jelszavát.</p><p>Kattintson erre a linkre <a href="%1$s">új jelszó</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Köszönjük, hogy az PPDA Help Desk-ot használja!',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk csak olvasás módban',
	'UI:AccessRO-Users' => 'PPDA Help Desk csak olvasás módban a végfelhasználók számára',
	'UI:ApplicationEnvironment' => 'Alkalmazáskörnyezet: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => 'A jelszavak nem egyeznek!',
	'UI:Button:Login' => 'Belépés az PPDA Help Desk alkalmazásba',
	'UI:Login:Error:AccessRestricted' => 'PPDA Help Desk hozzáférés korlátozva. Kérem forduljon az PPDA Help Desk rendszergazdához!',
	'UI:Login:Error:AccessAdmin' => 'Adminisztrátori hozzáférés korlátozott. Kérem forduljon az PPDA Help Desk rendszergazdához!',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - tömeges betöltés',
	'UI:Title:BulkImport+' => '',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Univerzális kereső',
	...
	'UI:CSVExport:LostChars+' => 'A letöltött fájl %1$s kódolású lesz. PPDA Help Desk olyan karaktereket észlelt, amelyek nem kompatibilisek ezzel a formátummal. Ezeket a karaktereket vagy helyettesítő karakterekkel helyettesítjük (pl. az ékezetes karakterek elveszítik az ékezetet), vagy elvetjük őket. Az adatokat a webböngészőből másolhatja/beillesztheti. Alternatívaként a rendszergazdához is fordulhat a kódolás megváltoztatásához (lásd a \'csv_file_default_charset\' paramétert).',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - OQL lekérdezés értékelés',
	...
	'UI:WelcomeToITop' => 'Üdvözli az PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s részletek',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Hiba',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Keresés eredményei',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s módosítása',
	'UI:ModificationTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> módosítása',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - %1$s - %2$s klón módosítása',
	'UI:CloneTitle_Class_Object' => '%1$s: <span class=\\"hilite\\">%2$s</span> klón',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - %1$s létrehozása',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Tömeges törlés',
	'UI:BulkDeleteTitle' => 'Válassza ki a törölni kívánt objektumokat:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk objektum létrehozva.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Végzetes hiba',
	'UI:SystemIntrusion' => 'Hozzáférés megtagadva. A művelet végrehajtása nem engedélyezett.',
	'UI:FatalErrorMessage' => 'Végzetes hiba, PPDA Help Desk nem tudja a műveletet folytatni',
	'UI:Error_Details' => 'Hiba: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk Felhasználókezelés - Profiltervezés',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Az PPDA Help Desk alkalmazásban az értesítések teljesen testreszabhatók. Értesítések az objektumok két csoportjára épülnek: <i>eseményindítók és műveletek</i>.</p>
...
A művelet eseményindítóhoz rendelésekor kap egy sorszámot , amely meghatározza a műveletek végrehajtási sorrendjét.</p>',
	...
	'Portal:Title' => 'PPDA Help Desk felhasználói portál',
	'Portal:NoRequestMgmt' => 'Üdv, %1$s, Önt erre az oldalra irányítottuk át, mert fiókjában a \'Portál felhasználó\' profil van beállítva. Sajnos a PPDA Help Desk nem lett telepítve \'Kérelemkezelés\' funkcióval. Kérjük, lépjen kapcsolatba a rendszergazdával.',
...
<tr><td>s</td><td>seconds (2 számjegy, pl. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'PPDA Help Desk névjegye ...',
	'UI:About:Title' => 'PPDA Help Desk névjegye',
	...
	'portal:backoffice' => 'PPDA Help Desk Adminisztrációs felület',
...
- The R&amp;D Team',
	...
	'Class:UserLocal' => 'PPDA Help Desk felhasználó',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'PPDA Help Desk szervezeten belüli felhasználók',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'PPDA Help Desk lemezterület',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Nézze meg az iTop Hub áruházát, az Ön egyablakos helyét, ahol csodálatos PPDA Help Desk bővítményeket talál!</br>Keresse meg azokat, amelyek segítenek a PPDA Help Desk testreszabásában és az Ön folyamataihoz való igazításában.</br><br/>Ha erről az oldalról csatlakozik a Hub-hoz, akkor a Hub-ra továbbítja a PPDA Help Desk példányára vonatkozó információkat.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Hiba történt telepítés közben!<br/>Az PPDA Help Desk konfigurációja NEM lett elmentve.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'A következő bővítményeket kézi másolással telepítettük a PPDA Help Desk %1$s könyvtárába:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Böngésszen az iTop Hub-ban, hogy megtalálja azokat a bővítményeket, amelyek segítenek testreszabni és az Ön folyamataihoz igazítani az PPDA Help Desk-ot !',
	'iTopHub:ExtensionNotInstalled' => 'Nincs telepítve',
	'iTopHub:GetMoreExtensions' => 'Bővítmények beszerzése az iTop Hub-ról...',
	'iTopHub:LandingWelcome' => 'Gratulálunk! A következő bővítményeket letöltöttük az iTop Hub-ról, és telepítettük az Ön PPDA Help Desk példányára.',
	'iTopHub:GoBackToITopBtn' => 'Vissza az PPDA Help Desk-hoz',
	...
	'iTopHub:DBBackupSentence' => 'A frissítés előtt biztonsági mentést készítünk az adatbázisról és az PPDA Help Desk konfigurációról.',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'PPDA Help Desk példány backup...',
...
FONTOS: Ha be van állítva, az \'Üzenet\' figyelmen kívül marad.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum törléséhez az PPDA Help Desk',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum szerkesztéséhez az PPDA Help Desk',
...
FONTOS: Ha be van állítva, a \'Üzenet\' és az összes \'Bot információ\' figyelmen kívül marad.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum törléséhez az PPDA Help Desk',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Rakjon ki egy gombot az üzenet alatt az objektum szerkesztéséhez az PPDA Help Desk',
