...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:UserInternal+' => 'Учетная запись создана внутри PPDA Help Desk',
	...
	'Menu:WelcomeMenu+' => 'Добро пожаловать в PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Добро пожаловать',
	'Menu:WelcomeMenuPage+' => 'Добро пожаловать в PPDA Help Desk',
	...
	'BooleanLabel:yes' => 'да',
	'BooleanLabel:no' => 'нет',
	'UI:Login:Title' => 'Вход в PPDA Help Desk',
	'UI:WelcomeMenu:Title' => 'Добро пожаловать в PPDA Help Desk',
	...
	'UI:Login:Welcome' => 'Добро пожаловать в PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'Введите свой логин для входа в систему и нажмите "Отправить". PPDA Help Desk отправит email с инструкциями по восстановлению пароля на ваш электронный адрес.',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Вы запросили восстановление пароля PPDA Help Desk.</p><p>Пожалуйста, воспользуйтесь <a href="%1$s">этой ссылкой</a> для задания нового пароля.</p></body>',
	...
	'UI:LogOffMenu' => 'Выход',
	'UI:LogOff:ThankYou' => 'Спасибо за использование PPDA Help Desk',
	...
	'UI:Login:Error:AccessRestricted' => 'Доступ к PPDA Help Desk ограничен. Пожалуйста, свяжитесь с администратором PPDA Help Desk.',
	'UI:Login:Error:AccessAdmin' => 'Доступ ограничен для лиц с административными привилегиями. Пожалуйста, свяжитесь с администратором PPDA Help Desk.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - Пакетный импорт',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Универсальный поиск',
	...
	'UI:Audit:Title' => 'PPDA Help Desk - Аудит CMDB',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Оценка запросов OQL',
	...
	'UI:WelcomeToITop' => 'Добро пожаловать в PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s подробности',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Ошибка',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Результаты поиска',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - Изменение объекта %2$s - %1$s',
	'UI:ModificationTitle_Class_Object' => 'Изменение объекта %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Клон %1$s - %2$s модификация',
	'UI:CloneTitle_Class_Object' => 'Клон %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Создание объекта %1$s',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Пакетное удаление',
	'UI:BulkDeleteTitle' => 'Выбор объектов для удаления:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Объект создан.',
	...
	'UI:PageTitle:FatalError' => 'PPDA Help Desk - Критическая ошибка',
	'UI:SystemIntrusion' => 'Доступ запрещён. Вы пытаетесь выполнить неразрешённую операцию.',
	'UI:FatalErrorMessage' => 'Критическая ошибка, PPDA Help Desk не может продолжать работу.',
	'UI:Error_Details' => 'Ошибка: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk управление пользователями - проектирование профилей',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>В PPDA Help Desk полностью настраиваемые уведомления, которые основаны на двух наборах объектов: <i>триггерах и действиях</i>.</p>
<p><i><b>Триггеры</b></i> определяют, когда необходимо выполнить действия. Базовые триггеры доступны как часть ядра PPDA Help Desk, другие триггеры добавляются дополнительными расширениями:
<ol>
...
<p>Для выполнения действия связываются с триггерами. При связывании с триггером каждому действию присваивается порядковый номер, который указывает на очерёдность выполнения действий при срабатывании триггера.</p>',
	...
	'Portal:Title' => 'Пользовательский портал PPDA Help Desk',
	'Portal:NoRequestMgmt' => 'Уважаемый %1$s, вы были перенаправлены на портал, потому что ваш аккаунт содержит профиль \'Portal user\'. К сожалению, PPDA Help Desk не содержит модуля \'Request Management\'. Пожалуйста, свяжитесь с вашим администратором.',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Об этом PPDA Help Desk...',
	'UI:About:Title' => 'Об этом PPDA Help Desk',
	...
	'portal:backoffice' => 'PPDA Help Desk Back-Office интерфейс',
...
- The R&amp;D Team',
	...
	'Class:UserExternal+' => 'Пользователь, аутентифицируемый вне PPDA Help Desk',
	...
	'Class:UserLocal' => 'Пользователь PPDA Help Desk',
	'Class:UserLocal+' => 'Пользователь, аутентифицируемый через PPDA Help Desk',
	...
	'Attachments:UploadNotAllowedOnThisSystem' => 'Загрузка файлов НЕ разрешена в этой системе. За подробностями обратитесь к администратору вашего PPDA Help Desk',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'Пользователи PPDA Help Desk этой организации',
	...
	'Menu:iTopHub:Register+' => 'Перейдите в iTop Hub, чтобы обновить ваш экземпляр PPDA Help Desk',
	...
	'Menu:iTopHub:MyExtensions+' => 'Расширения, развернутые на данном экземпляре PPDA Help Desk',
