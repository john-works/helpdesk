...
Operatori:<br/>
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'Una Fonte dati di sincronizzazione può popolare solo una singola classe PPDA Help Desk',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Una (piccola) immagine del collegamento ipertestuale che rappresenta l\'applicazione con cui è sincronizzato PPDA Help Desk',
	...
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Utilizza gli attributi": L\'oggetto PPDA Help Desk corrisponde ai valori replica per ciascun attributo di sincronizzazione contrassegnato per la Conciliazione.
	"Utilizza la chiave primaria": si prevede che la colonna primary_key della replica contenga l\'identificatore dell\'oggetto PPDA Help Desk',
	...
	'Class:UserInternal+' => 'Utente definito all\'interno di PPDA Help Desk',
	...
	'UI:WelcomeMenu:Title' => 'Benveuto su PPDA Help Desk',
	...
	'UI:Login:Welcome' => 'Benvenuti su PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'PPDA Help Desk può inviarti un\'email contenente le istruzioni da seguire per reimpostare il tuo account.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reimposta la password di PPDA Help Desk',
	'UI:ResetPwd-EmailBody' => '<body><p>Hai richiesto di reimpostare la password di PPDA Help Desk.</p><p>Segui questo link (uso singolo) per <a href="%1$s">inserire una nuova password</a></p>.',
	...
	'UI:Login:About' => 'PPDA Help Desk Sviluppato da Combodo',
	...
	'UI:LogOff:ThankYou' => 'Grazie per aver scelto PPDA Help Desk',
	...
	'UI:AccessRO-All' => 'PPDA Help Desk è di sola lettura',
	'UI:AccessRO-Users' => 'PPDA Help Desk è di sola lettura per gli utenti finali',
	...
	'UI:Button:Login' => 'Entra in PPDA Help Desk',
	'UI:Login:Error:AccessRestricted' => 'L\'accesso a PPDA Help Desk è limitato. Si prega di contattare un amministratore PPDA Help Desk.',
	'UI:Login:Error:AccessAdmin' => 'Accesso limitato alle persone che hanno privilegi di amministratore. Si prega di contattare un amministratore PPDA Help Desk.',
	...
	'UI:Title:BulkImport' => 'PPDA Help Desk - importazione collettiva',
	'UI:Title:BulkImport+' => '',
	...
	'UI:UniversalSearchTitle' => 'PPDA Help Desk - Ricerca Universale',
	...
	'UI:CSVExport:LostChars+' => 'Il file scaricato sarà codificato in %1$s. PPDA Help Desk ha rilevato alcuni caratteri che non sono compatibili con questo formato. Questi caratteri verranno sostituiti da un sostituto (ad esempio, caratteri accentati che perderanno l\'accento) o verranno eliminati. Puoi copiare/incollare i dati dal tuo browser web. In alternativa, puoi contattare il tuo amministratore per cambiare la codifica (vedi parametro \'csv_file_default_charset\').',
	'UI:Audit:Title' => 'PPDA Help Desk - Audit CMDB',
	...
	'UI:RunQuery:Title' => 'PPDA Help Desk - Valutazione Query OQL',
	...
	'UI:Query:UrlV1' => 'L\'elenco dei campi è stato lasciato non specificato. La pagina <em>export-V2.php</em> non può essere invocata senza queste informazioni. Pertanto, l\'URL suggerito di seguito punta alla pagina legacy: <em>export.php</em>. Questa versione legacy dell\'esportazione ha il seguente limite: l\'elenco dei campi esportati può variare a seconda del formato di output e del modello di dati di PPDA Help Desk.Se vuoi garantire che l\'elenco delle colonne esportate rimanga stabile nel lungo periodo, devi specificare un valore per l\'attributo "Campi" e utilizzare la pagina <em>export-V2.php</em>.',
	'UI:Schema:Title' => 'PPDA Help Desk schema degli oggetti',
	...
	'UI:WelcomeToITop' => 'Benvenuto su PPDA Help Desk',
	'UI:DetailsPageTitle' => 'PPDA Help Desk - %1$s - %2$s dettagli',
	'UI:ErrorPageTitle' => 'PPDA Help Desk - Errore',
	...
	'UI:SearchResultsPageTitle' => 'PPDA Help Desk - Risultati della ricerca',
	...
	'UI:ModificationPageTitle_Object_Class' => 'PPDA Help Desk - %1$s - Modifica %2$s',
	'UI:ModificationTitle_Class_Object' => 'Modifica di %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'PPDA Help Desk - Clone %1$s - Modifica %2$s',
	'UI:CloneTitle_Class_Object' => 'Clone di %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'PPDA Help Desk - Creazione di un nuovo %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'PPDA Help Desk - Eliminazione di massa',
	'UI:BulkDeleteTitle' => 'Seleziona gli oggetti che si desidera eliminare:',
	'UI:PageTitle:ObjectCreated' => 'PPDA Help Desk Oggetto Creato.',
	...
	'UI:FatalErrorMessage' => 'Fatal error, PPDA Help Desk non può continuare.',
	'UI:Error_Details' => 'Errore: %1$s.',
	'UI:PageTitle:ProfileProjections' => 'PPDA Help Desk gestione degli utenti - proiezioni profilo',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>In PPDA Help Desk le notifiche sono completamente personalizzabili. Esse si basano su due serie di oggetti: <i>trigger e azioni</i>.</p>
<p><i>I <b>trigger</b></i> definiscono quando verrà eseguita una notifica. Ci sono diversi trigger come parte del nucleo di PPDA Help Desk, ma altri possono essere forniti da estensioni:
<ol>
...
Quando è associata a un trigger, a ogni azione è assegnato un numero "ordine", che specifica in quale ordine le azioni devono essere eseguite.</p>',
	...
	'Portal:Title' => 'Portale Utente PPDA Help Desk',
	'Portal:NoRequestMgmt' => 'Caro %1$s, sei stato reindirizzato a questa pagina perché il tuo account è configurato con il profilo "Utente del portale". Purtroppo, PPDA Help Desk non è stato installato con la funzionalità "Gestione delle richieste". Si prega di contattare l\'amministratore.',
	...
	'UI:AboutBox' => 'Informazioni su PPDA Help Desk...',
	'UI:About:Title' => 'Informazioni su PPDA Help Desk',
	...
	'portal:backoffice' => 'Interfaccia utente di PPDA Help Desk Back-Office',
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'Class:UserExternal+' => 'Utente autenticato al di fuori di PPDA Help Desk',
	...
	'Class:UserLocal' => 'Utente PPDA Help Desk',
	'Class:UserLocal+' => 'Utente autenticato da PPDA Help Desk',
	...
	o chiedi al tuo amministratore di PPDA Help Desk se il disco del server PPDA Help Desk è pieno.',
	...
	'config-not-allowed-in-demo' => 'Spiacente, PPDA Help Desk è in <b>modalità dimostrativa</b>: il file di configurazione non può essere modificato.',
	'config-interactive-not-allowed' => 'La modifica interattiva della configurazione di PPDA Help Desk è stata disabilitata. Vedere <code>\'config_editor\' => \'disabled\'</code> nel file di configurazione.',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'PPDA Help Desk spazio su disco',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Avvia PPDA Help Desk Setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'Questo avvierà PPDA Help Desk setup, sei sicuro?',
	...
	'Menu:iTopHub:Register+' => 'Vai a iTop Hub per aggiornare la tua istanza di PPDA Help Desk',
	'Menu:iTopHub:Register:Description' => '<p>Ottieni accesso alla tua piattaforma comunitaria iTop Hub!</br>Trova tutti i contenuti e le informazioni di cui hai bisogno, gestisci le tue istanze con strumenti personalizzati e installa più estensioni.</br><br/>Connettendoti all\'Hub da questa pagina, invierai informazioni su questa istanza di PPDA Help Desk all\'Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Estensioni implementate',
	'Menu:iTopHub:MyExtensions+' => 'Vedi l\'elenco delle estensioni implementate su questa istanza di PPDA Help Desk',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Dai un\'occhiata allo store di iTop Hub, il tuo posto unico per trovare fantastiche estensioni di PPDA Help Desk!</br>Trova quelle che ti aiuteranno a personalizzare e adattare PPDA Help Desk ai tuoi processi.</br><br/>Connettendoti all\'Hub da questa pagina, invierai informazioni su questa istanza di PPDA Help Desk all\'Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Errore rilevato durante il deployment!<br/>La configurazione di PPDA Help Desk NON è stata modificata.',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'Le seguenti estensioni sono state implementate manualmente copiandole nella directory %1$s di PPDA Help Desk:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Cerca su iTop Hub le estensioni che ti aiuteranno a personalizzare e adattare PPDA Help Desk ai tuoi processi!',
	'iTopHub:ExtensionNotInstalled' => 'Non installata',
	'iTopHub:GetMoreExtensions' => 'Ottieni estensioni da iTop Hub...',
	'iTopHub:LandingWelcome' => 'Congratulazioni! Le seguenti estensioni sono state scaricate da iTop Hub e implementate nella tua PPDA Help Desk.',
	'iTopHub:GoBackToITopBtn' => 'Torna a PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Esegui un backup del database e della configurazione di PPDA Help Desk prima dell\'aggiornamento',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup dell\'istanza PPDA Help Desk...',
