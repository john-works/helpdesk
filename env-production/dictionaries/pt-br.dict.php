...
Dict::SetEntries('PT BR', array(
	...
	'Core:AttributeDashboard' => 'Painel do PPDA Help Desk',
	...
	'Core:AttributeTemplateString+' => 'String de uma linha, contendo espaços reservados para dados do PPDA Help Desk',
	'Core:AttributeTemplateText' => 'Texto do modelo',
	'Core:AttributeTemplateText+' => 'Texto contendo espaços reservados para dados do PPDA Help Desk',
	'Core:AttributeTemplateHTML' => 'HTML do modelo',
	'Core:AttributeTemplateHTML+' => 'Código HTML contendo espaços reservados para dados do PPDA Help Desk',
...
- Otherwise, the application compact logo will be used',
	...
	'Class:SynchroDataSource/Attribute:scope_class+' => 'A Synchro Data Source can only populate a single PPDA Help Desk class',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperlink de uma pequena imagem representando o aplicativo com o qual o PPDA Help Desk é sincronizado',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hiperlink de aplicativo',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperlink para o objeto na aplicação externa com a qual o PPDA Help Desk é sincronizado (se aplicável). As substituições possíveis: $this->attribute$ e $replica->primary_key$',
	'Class:SynchroDataSource/Attribute:reconciliation_policy' => 'Política de reconciliação',
	'Class:SynchroDataSource/Attribute:reconciliation_policy+' => '"Use the attributes": PPDA Help Desk object matches replica values for each Synchro attributes flagged for Reconciliation.
"Use primary_key": the column primary_key of the replica is expected to contain the identifier of the PPDA Help Desk object',
...
Domain usually correspond to who is responsible for checking and fixing errors',
	...
	'Class:User/Attribute:login+' => 'Login de acesso ao PPDA Help Desk',
	...
	'Class:UserInternal+' => 'Usuário definido dentro do PPDA Help Desk',
	...
	'Menu:WelcomeMenu' => 'Página inicial do PPDA Help Desk',
	'Menu:WelcomeMenu+' => 'Bem-vindo ao PPDA Help Desk',
	'Menu:WelcomeMenuPage' => 'Página inicial do PPDA Help Desk',
	'Menu:WelcomeMenuPage+' => 'Bem-vindo ao PPDA Help Desk',
	...
	'BooleanLabel:no' => 'Não',
	'UI:Login:Title' => 'Login no PPDA Help Desk',
	'UI:WelcomeMenu:Title' => 'Bem-vindo ao PPDA Help Desk',
	...
	'UI:Error:UploadedFileTooBig' => 'O arquivo a ser carregado é muito grande (Tamanho máximo permitido é de %1$s). Para modificar esse limite, contate o administrador do PPDA Help Desk (Verifique a configuração do PHP para upload_max_filesize e post_max_size no servidor)',
	...
	'UI:Login:Welcome' => 'Bem-vindo ao PPDA Help Desk!',
	...
	'UI:Login:ForgotPwdForm+' => 'O PPDA Help Desk pode enviar um e-mail em que você vai encontrar instruções para seguir para redefinir sua conta',
	...
	'UI:ResetPwd-Error-NoEmailAtt' => 'A conta não está associada a uma pessoa que contém um endereço de e-mail no PPDA Help Desk.Por favor, contate o administrador',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Você solicitou a alteração da senha do PPDA Help Desk.</p><p>Por favor, siga este link (passo simples) para <a href="%1$s">digitar a nova senha</a></p>.',
	...
	'UI:AccessRO-Users' => 'PPDA Help Desk é somente leitura para usuários finais',
	...
	'UI:CSVExport:LostChars+' => 'O arquivo baixado será codificado em %1$s. O PPDA Help Desk detectou alguns caracteres que não são compatíveis com este formato. Esses caracteres serão substituídos por um substituto (por exemplo, caracteres acentuados perdendo o acento) ou serão descartados. Você pode copiar/colar os dados do seu navegador da web. Como alternativa, você pode entrar em contato com seu administrador para alterar a codificação (consulte o parâmetro \'csv_file_default_charset\' do arquivo de configuração do PPDA Help Desk)',
	...
	'UI:WelcomeToITop' => 'Bem-vindo ao PPDA Help Desk',
...
Quando associada a um gatilho, cada ação recebe um número de "ordem", especificando em qual ordem as ações devem ser executadas.</p>',
	...
	'UI:AutoApplyConfirmationMessage' => 'Algumas alterações ainda não foram aplicadas. Você quer que o PPDA Help Desk os leve em consideração?',
...
<tr><td>s</td><td>segundos (2 dígitos, ex. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Sobre o PPDA Help Desk...',
	'UI:About:Title' => 'Sobre o PPDA Help Desk',
	...
	'portal:legacy_portal' => 'Portal do usuário (legado) do PPDA Help Desk',
	'portal:backoffice' => 'Interface de usuário back-office do PPDA Help Desk',
	...
	'UI:Newsroom:iTopNotification:Label' => 'PPDA Help Desk',
	'UI:Newsroom:iTopNotification:ViewAllPage:Title' => 'Your PPDA Help Desk news',
	...
	'UI:WelcomePopup:Message:320_01_Welcome:Title' => 'Welcome to PPDA Help Desk 3.2',
	'UI:WelcomePopup:Message:320_01_Welcome:Description' => '<div>Congratulations, you landed on PPDA Help Desk Fullmoon!</div>
<br>
<div>We\'re excited to announce this new release. </div>
<div>In addition to introducing new features such as Newsroom, PPDA Help Desk 3.2 includes critical security patches, enhanced accessibility and other significant improvements focused on providing you with stability and security.</div>
<br>
<div>Discover all of PPDA Help Desk\'s exciting new features and stay up-to-date with important notifications with our new welcome pop-up!</div>
<div>We hope you\'ll enjoy this version as much as we enjoyed imagining and creating it.</div>
<br>
<div>Customize your PPDA Help Desk preferences for a personalized experience.</div>',
	'UI:WelcomePopup:Message:320_02_Newsroom:Title' => 'Say "Hello" to the newsroom',
	'UI:WelcomePopup:Message:320_02_Newsroom:Description' => '<div>Say goodbye to cluttered inboxes and hello to personalized alerts with <a href="%1$s" target="_blank">PPDA Help Desk\'s Newsroom</a>!</div>
...
<br>
<div>Try it out today and streamline your PPDA Help Desk\'s communication experience!</div>',
...
<div>Access your <a href="%1$s" target="_blank">notifications center</a> through the newsroom or through your preferences and avoid information overload on all your communication channels!</div>',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Title' => 'Accessibility for PPDA Help Desk\'s UI',
	'UI:WelcomePopup:Message:320_05_A11yThemes:Description' => '<div>To ensure PPDA Help Desk\'s accessibility, our team has been working on <a href="%1$s" target="_blank">new back-office themes</a>. WCAG compliants, those UI focus on making it easier for users with visual impairments to use the solution:
<ul>
	...
	'UI:WelcomePopup:Message:320_04_PowerfulNotifications_AdminOnly:Description' => '<div>PPDA Help Desk\'s Newsroom gives you a new way to <a href="%1$s" target="_blank"><b>automate</b> your alerts based on events</a> with recurrence, so you can easily set up rules that work for you. </div>
...
<div>Configure it today and see how much more efficient your alerts process can be!</div>',
	...
	'UI:Component:GlobalSearch:Tooltip' => 'Pesquisar em todo o PPDA Help Desk',
	...
	'UI:ErrorPage:KittyDisclaimer' => 'Nenhum gatinho foi ferido durante a confecção deste GIF e lançamento de versão do PPDA Help Desk.
...
ou entre em contato com o seu administrador do PPDA Help Desk pois o servidor pode estar sem espaço de armazenamento',
	...
	'bkp-mysqldump-notfound' => 'mysqldump não foi encontrado: %1$s - Por favor, verifique se ele está instalado e no caminho, ou edite o arquivo de configuração do PPDA Help Desk para ajustar o parâmetro mysql_bindir',
	'bkp-mysqldump-issue' => 'falha durante a execução do mysqldump (retcode=%1$d): Por favor, certifique-se de que o mysqldump está instalado e o caminho está correto, ou edite o arquivo de configuração do PPDA Help Desk para ajustar o parâmetro mysql_bindir',
	...
	'bkp-next-to-delete' => 'Será deletado quando ocorrer o próximo backup (consulte o parâmetro "retention_count" do arquivo de configuração do PPDA Help Desk)',
	...
	'config-not-allowed-in-demo' => 'Sorry, PPDA Help Desk is in <b>demonstration mode</b>: the configuration file cannot be edited.',
	'config-interactive-not-allowed' => 'PPDA Help Desk interactive edition of the configuration as been disabled. See <code>\'config_editor\' => \'disabled\'</code> in the configuration file.',
	...
	'Page:DefaultTitle' => 'PPDA Help Desk - Portal do Usuário',
	...
	'Brick:Portal:AggregatePage:DefaultTitle' => 'Painel do PPDA Help Desk',
...
The delivery model specifies the teams to which tickets can be assigned.',
	...
	'Organization:Overview:Users' => 'Usuários do PPDA Help Desk associados à esta organização',
	...
	'iTopUpdate:UI:PageTitle' => 'Atualização do PPDA Help Desk',
	'itop-core-update:UI:SelectUpdateFile' => 'Atualização do PPDA Help Desk',
	'itop-core-update:UI:ConfirmUpdate' => 'Atualização do PPDA Help Desk',
	'itop-core-update:UI:UpdateCoreFiles' => 'Atualização do PPDA Help Desk',
	'iTopUpdate:UI:MaintenanceModeActive' => 'O PPDA Help Desk encontra-se em manutenção, nenhum usuário pode acessar a aplicação. Você precisa rodar o Setup ou restaurar os arquivos da aplicação para voltar ao modo normal',
	'itop-core-update:UI:UpdateDone' => 'Atualização do PPDA Help Desk',
	'itop-core-update/Operation:SelectUpdateFile/Title' => 'Atualização do PPDA Help Desk',
	'itop-core-update/Operation:ConfirmUpdate/Title' => 'Confirmar Atualização do PPDA Help Desk',
	'itop-core-update/Operation:UpdateCoreFiles/Title' => 'Aplicação em Atualização',
	'itop-core-update/Operation:UpdateDone/Title' => 'Atualização do PPDA Help Desk finalizada',
	...
	'iTopUpdate:UI:Setup' => 'PPDA Help Desk Setup',
	...
	'iTopUpdate:UI:ItopDiskSpace' => 'Espaço em disco do PPDA Help Desk',
	...
	'iTopUpdate:UI:SetupLaunch' => 'Launch PPDA Help Desk Setup',
	'iTopUpdate:UI:SetupLaunchConfirm' => 'This will launch PPDA Help Desk setup, are you sure?',
	...
	'Menu:iTopUpdate' => 'Atualização do PPDA Help Desk',
	'Menu:iTopUpdate+' => 'Atualização do PPDA Help Desk',
	...
	'Menu:iTopHub:Register+' => 'Vá para o iTop Hub para atualizar sua instância PPDA Help Desk',
	'Menu:iTopHub:Register:Description' => '<p>Obtenha acesso à sua plataforma da comunidade iTop Hub!</br>Encontre todos os conteúdos e informações necessárias, gerencie suas instâncias PPDA Help Desk por meio de ferramentas personalizadas & instale mais extensões.</br><br/>Ao conectar-se ao iTop hub a partir desta página, você enviará informações da sua instância PPDA Help Desk ao iTop Hub.</p>',
	'Menu:iTopHub:MyExtensions' => 'Extensões Implantadas',
	'Menu:iTopHub:MyExtensions+' => 'Veja a lista de extensões implantadas nesta instância do PPDA Help Desk',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>Visite a loja do iTop Hub, seu único lugar para encontrar extensões maravilhosas do PPDA Help Desk !</br>Encontre as extensões que irão ajudá-lo a personalizar e adaptar o PPDA Help Desk aos seus processos.</br><br/>Ao conectar-se ao iTop hub a partir desta página, você enviará informações da sua instância PPDA Help Desk ao iTop Hub.</p>',
	...
	'iTopHub:ConfigurationSafelyReverted' => 'Erro detectado durante a implantação!<br/>A configuração do PPDA Help Desk NÃO foi modificada',
	...
	'iTopHub:ExtensionCategory:Manual+' => 'As seguintes extensões foram implantadas copiando-as manualmente no diretório %1$s do PPDA Help Desk:',
	...
	'iTopHub:NoExtensionInThisCategory+' => 'Acesse o iTop Hub para encontrar as extensões que ajudarão você a personalizar e adaptar o PPDA Help Desk aos seus processos !',
	'iTopHub:ExtensionNotInstalled' => 'Não instalado',
	'iTopHub:GetMoreExtensions' => 'Obter extensões do iTop Hub...',
	'iTopHub:LandingWelcome' => 'Parabéns! As extensões a seguir foram baixadas do iTop Hub e implantadas no seu PPDA Help Desk',
	'iTopHub:GoBackToITopBtn' => 'Voltar para o PPDA Help Desk',
	...
	'iTopHub:DBBackupSentence' => 'Faça um backup do banco de dados e configuração do PPDA Help Desk antes de atualizar',
	...
	'iTopHub:InstallationProgress:DatabaseBackup' => 'Backup da instância do PPDA Help Desk...',
...
Erase the field to recalculate default value',
	...
	'Class:PersonalToken+' => 'Personal token for accessing PPDA Help Desk webservices, import, export, rest and data synchro',
	...
	'Class:UserToken+' => 'User for remote applications accessing PPDA Help Desk webservices',
...
IMPORTANT: If set, the \'message\' will be ignored.',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_delete_button+' => 'Include a button below the message to delete the object in PPDA Help Desk',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:include_modify_button+' => 'Include a button below the message to edit the object in PPDA Help Desk',
...
IMPORTANT: If set, the \'message\' and all \'bot information\' will be ignored.',
	...
	'Class:ActionSlackNotification/Attribute:include_delete_button+' => 'Include a button below the message to delete the object in PPDA Help Desk',
	...
	'Class:ActionSlackNotification/Attribute:include_modify_button+' => 'Include a button below the message to edit the object in PPDA Help Desk',
...
- $oResponse can be null in some cases (eg. request failed to send)',
	...
	'Class:ActioniTopWebhook' => 'Action by PPDA Help Desk REST API',
