...
;
    ...
    public function DBInsertNoReload()
    {
          ...
          $oNewObjectCallback = function () use ($sClass)
          {
              $sRootTable = MetaModel::DBGetTable('Ticket');
              return (int) CMDBSource::QueryToScalar("SELECT COALESCE(MAX(CAST(SUBSTRING(ref, 3) AS UNSIGNED)), 0) FROM `$sRootTable` WHERE finalclass = ".CMDBSource::Quote($sClass)." AND ref LIKE '%-%'");
          };
          $iNextId = ItopCounter::Inc($sClass, $oNewObjectCallback);
